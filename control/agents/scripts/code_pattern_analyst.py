...
BASE_TEMPLATE_PATH = "control/agents/subagents/code-pattern-analyst/base.md"
LANG_TEMPLATE_PATH = "control/agents/subagents/code-pattern-analyst/{lang}.md"
OUTPUT_PATH = "generated/.opencode/agent/subagent/code-pattern-analyst.md"
