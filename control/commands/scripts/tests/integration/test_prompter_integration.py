...
class TestPrompterIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        (self.project_root / "control/commands/generic").mkdir(parents=True, exist_ok=True)
        (self.project_root / "generated/.opencode/command").mkdir(parents=True, exist_ok=True)
...
"""
        ...
        # Check output file
        output_file = self.project_root / "generated/.opencode/command/prompter.md"
