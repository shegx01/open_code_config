...
class WorktreesConfigGenerator:
    ...
    def validate_and_read_template(self, worktrees_config: Dict[str, Any]) -> str:
        ...
        if additional_files_strategy != 'replace' or not additional_files:
            if template_type == 'default':
                ...
                default_template_path = self.project_root / "control/commands/generic/worktrees.md"
    ...
    def write_yaml_config(self, worktrees_config: Dict[str, Any], template_content: str, output_path: str = "generated/.opencode/command/worktrees.md") -> None:
