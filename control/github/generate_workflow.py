...
Examples:
  ...
  python generate_workflow.py --config config.toml
  ...
  python generate_workflow.py --output - --verbose  # Print to stdout with config summary
    ...
    parser.add_argument(
        '--output', '-o',
        default='generated/.github/workflows/opencode.yml',
        help='Output file path (default: generated/.github/workflows/opencode.yml)'
    )
