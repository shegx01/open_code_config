...
class TestEndToEndIntegration(unittest.TestCase):
    ...
    def test_successful_generation_with_default_template(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            default_template_dir = temp_path / "ogc/control/commands/generic"
    ...
    def test_successful_generation_with_custom_template(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            custom_template_dir = temp_path / "ogc/control/commands/scripts/tests/fixtures"
    ...
    def test_error_handling_custom_empty_template(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            empty_template_dir = temp_path / "ogc/control/commands/scripts/tests/fixtures"
