...
"""
            ...
            output_file = temp_path / "ogc/generated/.opencode/command/context.md"
...
"""
    ...
    def _create_mock_project_structure(self, temp_path: Path):
        ...
        (temp_path / "ogc/control/commands/generic").mkdir(parents=True, exist_ok=True)
        (temp_path / "ogc/generated/.opencode/command").mkdir(parents=True, exist_ok=True)
...
- **Practical insights**: Actual workflow vs documented workflow"""
        ...
        default_template_path = temp_path / "ogc/control/commands/generic/context.md"
