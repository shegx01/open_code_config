...
class TestTestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_path = Path(self.temp_dir) / "ogc" / "config.toml"
        self.config_path.parent.mkdir(parents=True, exist_ok=True)
        
        # Create template directories
        self.template_dir = Path(self.temp_dir) / "ogc" / "control" / "commands" / "generic" / "test"
        self.template_dir.mkdir(parents=True, exist_ok=True)
        
        # Create output directory
        self.output_dir = Path(self.temp_dir) / "ogc" / "generated" / ".opencode" / "command"
...
"""
        ...
        output_file = Path(self.temp_dir) / "ogc" / "generated" / ".opencode" / "command" / "test.md"
