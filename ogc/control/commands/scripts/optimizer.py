...
class OptimizerConfigGenerator:
    ...
    def validate_and_read_template(self, optimizer_config: Dict[str, Any]) -> str:
        ...
        additional_files_strategy = optimizer_config.get('additional_files_strategy', 'merge')
        lang = optimizer_config.get('lang', '')
        ...
        if additional_files_strategy != 'replace' or not additional_files:
            if template_type == 'default':
                ...
                if include_base_template:
                    base_template_path = self.project_root / "ogc/control/commands/generic/optimizer/base.md"
                ...
                if lang:
                    lang_template_path = self.project_root / f"ogc/control/commands/generic/optimizer/{lang}.md"
    ...
    def write_yaml_config(self, optimizer_config: Dict[str, Any], template_content: str, output_path: str = "ogc/generated/.opencode/command/optimizer.md") -> None:
...
{clean_content}"""
    ...
    def generate(self) -> bool:
        ...
        try:
            ...
            print(f"Error generating optimizer configuration: {e}", file=sys.stderr)
            sys.exit(1)
...
def main():
    ...
    if success:
        print("Optimizer configuration generated successfully")
    else:
        print("Optimizer configuration generation skipped")
