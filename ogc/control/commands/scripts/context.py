...
class ContextConfigGenerator:
    ...
    def validate_and_read_template(self, context_config: Dict[str, Any]) -> str:
        ...
        if additional_files_strategy != 'replace' or not additional_files:
            if template_type == 'default':
                ...
                default_template_path = self.project_root / "ogc/control/commands/generic/context.md"
    ...
    def write_yaml_config(self, context_config: Dict[str, Any], template_content: str, output_path: str = "ogc/generated/.opencode/command/context.md") -> None:
